...
fully pinned canonical spec) · 4ea2988 (cohort pin) — sealed by the tagged release
...
one above, and any future import will be recorded as an addition, never a substitution. Unless and until it is imported with its own hash, it has no standing: the freeze above is the only lock.
